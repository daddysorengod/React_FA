...
import { useStyles } from "./TableDetailEntryFixed.styles";
import {
  PARAM_INTERFACE,
...
import { AccountingEntryDetailTableDeposit } from "./conponents";
...
const TableDetailEntryFixedComponent = forwardRef(
  (props: Props, ref): JSX.Element => {
    ...
    return (
      <Box className={classes.tableWrap}>
        ...
        !workFollowStatus ? (
          <AccountingEntryDetailTableDeposit
            onlyShow={isDisabled}
...
const TableDetailEntryFixed = React.memo(TableDetailEntryFixedComponent);
export { TableDetailEntryFixed };
