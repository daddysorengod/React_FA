...
import getShadow from '@app/utils/getShadow';

// types
import { ButtonVariantProps, ExtendedStyleProps, IconButtonShapeProps } from '@app/types/extended';
...
const IconButton = forwardRef(({ variant, shape, children, color, tooltip, ...others }: Props, ref: Ref<HTMLButtonElement>) => {
