...
const TDAutomaticDepositCollectionFormComponent = forwardRef(
  (props: Props, ref): JSX.Element => {
    ...
    const getTableConfig = async () => {
      const res = await dispatch(
        getTableConfigStore(
          "INVESTMENT/TIME-DEPOSIT/EXPECTED-DEPOSIT-COLLECTION/ACCOUNTING-ENTRY-DETAILS",
        ),
      );
    ...
    return (
      <Box sx={{ backgroundColor: "#f4f7fa", height: "100vh" }}>
        <Grid
          container
          columns={12}
          columnSpacing={4}
...
const TDAutomaticDepositCollectionForm = React.memo(
  TDAutomaticDepositCollectionFormComponent,
);
export { TDAutomaticDepositCollectionForm };
