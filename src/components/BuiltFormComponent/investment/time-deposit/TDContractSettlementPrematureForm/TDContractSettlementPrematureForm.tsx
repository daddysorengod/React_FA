...
const TDContractSettlementPrematureFormComponent = forwardRef(
  (props: Props, ref): JSX.Element => {
    ...
    return (
      <Box className={classes.formContract}>
        <Grid
          container
          columns={12}
          columnSpacing={4}
          className={classes.formContractContainer}
        >
          <Grid item xs={10}>
            <Box className={classes.formContractContent}>
              <Box>
                <Grid
                  container
                  columns={10}
                  columnSpacing={4}
                  rowSpacing={2.5}
                  className={classes.formContractContentTop}
                >
                ...
                {detailedTableConfig && currentId ? (
                  <Box>
                    <Box className={classes.formAccountingEntry}>
                      {"Chi tiết bút toán"}
                    </Box>
                    <BaseAccountingEntryDetailsTable
                      ...
                      configGetData={{
                        ...
                        params: [
                          { paramKey: "accountingType", paramValue: "ACCRUED" },
                        ],
                      }}
                    />
                  </Box>
...
const TDContractSettlementPrematureForm = React.memo(
  TDContractSettlementPrematureFormComponent,
);
export { TDContractSettlementPrematureForm };
