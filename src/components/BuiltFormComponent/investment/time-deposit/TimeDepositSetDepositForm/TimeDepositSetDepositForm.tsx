...
const TimeDepositSetDepositFormComponent = forwardRef(
  (props: Props, ref): JSX.Element => {
    ...
    const validateAll = (): boolean => {
      const arr = ["transDate", "description"];
      let valid = true;
    ...
    const getDisabledProperty = (fieldConfig: FieldConfig): boolean => {
      ...
      if (!!onlyShow) {
        ...
        // Luôn disabled
        if (["transDate", "description"].includes(fieldConfig.key)) {
          return false;
        } else return true;
      }
...
const TimeDepositSetDepositForm = React.memo(
  TimeDepositSetDepositFormComponent,
);
export { TimeDepositSetDepositForm };
