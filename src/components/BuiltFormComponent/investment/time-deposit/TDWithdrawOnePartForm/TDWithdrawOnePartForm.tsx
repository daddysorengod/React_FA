...
const TDWithdrawOnePartFormComponent = forwardRef(
  (props: Props, ref): JSX.Element => {
    const { t } = useTranslation();
    const classes = useStyles();
    const { onlyShow, parentId, currentId, onCloseDialog } = props;
    ...
    const validateAll = (): boolean => {
      const arr = ["transDate", "description", "fundBankAccountId"];
      let valid = true;
...
const TDWithdrawOnePartForm = React.memo(TDWithdrawOnePartFormComponent);
export { TDWithdrawOnePartForm };
