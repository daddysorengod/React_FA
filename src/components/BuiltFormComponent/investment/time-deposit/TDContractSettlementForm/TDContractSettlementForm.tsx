...
const TDContractSettlementFormComponent = forwardRef(
...
const TDContractSettlementForm = React.memo(TDContractSettlementFormComponent);
export { TDContractSettlementForm };
